      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          <button
            ...
            className="px-4 py-2 text-sm font-body rounded-md bg-[hsl(var(--bg-teal))] text-primary border border-primary/20 hover:bg-[hsl(var(--bg-teal)/0.8)] transition-colors"
          >
            Strong Fit Example
          </button>
          <button
            onClick={() => { setJdText(weakFitJD); setResult(null); }}
            className="px-4 py-2 text-sm font-body rounded-md bg-[hsl(var(--bg-olive))] text-[hsl(var(--olive))] border border-[hsl(var(--olive)/0.3)] hover:bg-[hsl(var(--bg-olive)/0.8)] transition-colors"
          >
            Weak Fit Example
          </button>
        </div>
        ...
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 bg-[hsl(var(--mustard))] text-[hsl(var(--mustard-foreground))] font-body font-semibold text-sm rounded-md glow-warm hover:brightness-110 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
        >
        ...
        {result && (
          <div className="mt-10 space-y-8 animate-fade-in">
            <div className={`inline-flex items-center px-4 py-2 rounded-md text-sm font-body font-semibold border ${verdictStyles[result.verdict]}`}>
              {result.verdictLabel}
            </div>
            ...
            <div>
              <h4 className="text-xs tracking-[0.2em] uppercase text-[hsl(var(--olive))] font-body mb-3">Where I Don't Fit</h4>
            ...
            <div className="glass-card p-6 border-l-2 border-[hsl(var(--mustard)/0.5)]">
