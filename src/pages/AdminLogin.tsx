    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      <div className="glass-card p-8 w-full max-w-sm">
        ...
        <button
          ...
          className="mt-4 w-full py-3 bg-secondary text-foreground font-body font-medium text-sm rounded-lg hover:bg-secondary/80 transition-all flex items-center justify-center gap-2"
        >
        ...
        <button
          ...
          className="mt-2 w-full py-3 bg-foreground text-background font-body font-medium text-sm rounded-lg hover:opacity-90 transition-all flex items-center justify-center gap-2"
        >
